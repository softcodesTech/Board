...
public class Ruharo_campus extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = "http://newsportal.softcodes.tech/ruharo_campus_api.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Business_Adapter adapter = new Business_Adapter(Ruharo_campus.this, productList);
    ...
    public void Saveclicked_post(final String id_saved){
        ...
        class Saveclicked_post extends AsyncTask<String,Void,String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Intent view_classes = new Intent(Ruharo_campus.this, Reply_Comment.class);
