...
public class Applied_Sciences extends AppCompatActivity {

    private static final String URL_PRODUCTS = "http://newsportal.softcodes.tech/applied_sciences_api.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Business_Adapter adapter = new Business_Adapter(Applied_Sciences.this, productList);
    ...
    public void Saveclicked_post(final String id_saved){
        ...
        class Saveclicked_post extends AsyncTask<String,Void,String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Intent view_classes = new Intent(Applied_Sciences.this, Reply_Comment.class);
