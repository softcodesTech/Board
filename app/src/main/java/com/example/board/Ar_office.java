...
public class Ar_office extends AppCompatActivity {
    private static final String URL_PRODUCTS = "http://softcodes.tech/newsportal/ar_office_api.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Business_Adapter adapter = new Business_Adapter(Ar_office.this, productList);
    ...
    public void Saveclicked_post(final String id_saved){
        ...
        class Saveclicked_post extends AsyncTask<String,Void,String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Intent view_classes = new Intent(Ar_office.this, Reply_Comment.class);
