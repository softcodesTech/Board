...
public class Comment_Now extends AppCompatActivity {
    int count =0;
    private static final String URL_PRODUCTS = "https://softcodes.tech/newsportal/read_comments.php";
    ...
    String finalResult ;
    String HttpURL = "http://softcodes.tech/newsportal/save_comment.php";
